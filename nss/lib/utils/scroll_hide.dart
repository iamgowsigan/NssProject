...
class ScrollToHide extends StatefulWidget {
  ...
  bool revese=false;
  ScrollToHide({Key? key,required this.revese,required this.child,required this.controller, this.duration=const Duration(milliseconds: 200),this.afterPixel=0}) : super(key: key);
...
class _ScrollToHideState extends State<ScrollToHide> {
  ...
  Widget build(BuildContext context) {
    return AnimatedContainer(duration: widget.duration,
      height:isVisible? mySize.height:0,
      child: Wrap(
        children: [
