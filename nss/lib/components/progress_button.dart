...
class ProgressButton extends StatefulWidget {
  ...
  ProgressButton({Key? key,required this.showProgress,required this.btwidth,this.btheight=35,this.btpadding=0 ,required this.bttext,this.btround=5 ,this.bttextsize=10,this.btcolor=ThemeSecondary,this.bttxtcolor=Colors.white}) : super(key: key);
