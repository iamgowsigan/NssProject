...
import 'package:nss/components/loading_placement.dart';
      ...
      child:  Container(
        ...
        child:  SizedBox(
          ...
          child: CircularProgressIndicator(
              strokeWidth: 3.0,
              valueColor:
              new AlwaysStoppedAnimation<Color>(ThemePrimary)),
        ),
      ),
    );
  }
  imageWidget(BuildContext context) {
    return Material(
      ...
      child:  Container(
        ...
        child:  LoadingPlacement(width: Width(context), height:  Width(context)),
      ),
    );
  }
}
