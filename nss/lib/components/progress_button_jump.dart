...
import 'package:nss/anim/ease_in_widget.dart';
...
class ProgressButtonJump extends StatefulWidget {
  ...
  ProgressButtonJump({Key? key,required this.showProgress,required this.btwidth,this.btheight=35,this.btpadding=0 ,required this.bttext,this.btround=0 ,this.bttextsize=12,this.btcolor=ThemePrimary, required this.onTap}) : super(key: key);
