...
/// Different display modes of [CupertinoMonthYearPicker].
///
/// See also:
///
///  * [CupertinoMonthYearPicker], the class that implements different display modes
///    of the iOS-style date picker.
///  * [CupertinoPicker], the class that implements a content agnostic spinner UI.
enum CupertinoMonthYearMode {
  /// Mode that shows the date in hour, minute, and (optional) an AM/PM designation.
  /// The AM/PM designation is shown only if [CupertinoMonthYearPicker] does not use 24h format.
...
///
/// There are several modes of the date picker listed in [CupertinoMonthYearMode].
///
...
class CupertinoMonthYearPicker extends StatefulWidget {
  /// Constructs an iOS style date picker.
  ///
  /// [mode] is one of the mode listed in [CupertinoMonthYearMode] and defaults
  /// to [CupertinoMonthYearMode.dateAndTime].
  ///
  /// [onDateTimeChanged] is the callback called when the selected date or time
  /// changes and must not be null. When in [CupertinoMonthYearMode.time] mode,
  /// the year, month and day will be the same as [initialDateTime]. When in
  /// [CupertinoMonthYearMode.date] mode, this callback will always report the
  ...
  /// In [CupertinoMonthYearMode.time] mode, [minimumDate] should typically be
  ...
  /// In [CupertinoMonthYearMode.time] mode, [maximumDate] should typically be
  /// on the same date as [initialDateTime], as the picker will not limit the
  ...
  /// [CupertinoMonthYearMode.date] mode. Defaults to 1 and must not be null.
  ///
  /// [maximumYear] is the maximum year that the picker can be scrolled to in
  /// [CupertinoMonthYearMode.date] mode. Null if there's no limit.
  ///
  ...
  ///
  /// [dateOrder] determines the order of the columns inside [CupertinoMonthYearPicker] in date mode.
  /// Defaults to the locale's default date format/order.
  CupertinoMonthYearPicker({
    super.key,
    this.mode = CupertinoMonthYearMode.dateAndTime,
    ...
    assert(
    mode != CupertinoMonthYearMode.dateAndTime || minimumDate == null || !this.initialDateTime.isBefore(minimumDate!),
    'initial date is before minimum date',
    );
    assert(
    mode != CupertinoMonthYearMode.dateAndTime || maximumDate == null || !this.initialDateTime.isAfter(maximumDate!),
    'initial date is after maximum date',
    );
    assert(
    mode != CupertinoMonthYearMode.date || (minimumYear >= 1 && this.initialDateTime.year >= minimumYear),
    'initial year is not greater than minimum year, or minimum year is not positive',
    );
    assert(
    mode != CupertinoMonthYearMode.date || maximumYear == null || this.initialDateTime.year <= maximumYear!,
    'initial year is not smaller than maximum year',
    );
    assert(
    mode != CupertinoMonthYearMode.date || minimumDate == null || !minimumDate!.isAfter(this.initialDateTime),
    'initial date ${this.initialDateTime} is not greater than or equal to minimumDate $minimumDate',
    );
    assert(
    mode != CupertinoMonthYearMode.date || maximumDate == null || !maximumDate!.isBefore(this.initialDateTime),
  ...
  /// The mode of the date picker as one of [CupertinoMonthYearMode].
  /// Defaults to [CupertinoMonthYearMode.dateAndTime]. Cannot be null and
  /// value cannot change after initial build.
  final CupertinoMonthYearMode mode;
  ...
  ///
  /// In [CupertinoMonthYearMode.time] mode, a time becomes unselectable if the
  ...
  /// Determines the order of the columns inside [CupertinoMonthYearPicker] in date mode.
  /// Defaults to the locale's default date format/order.
  ...
  State<StatefulWidget> createState() { // ignore: no_logic_in_create_state, https://github.com/flutter/flutter/issues/70499
    ...
    // state.
    switch (mode) {
      case CupertinoMonthYearMode.time:
      case CupertinoMonthYearMode.dateAndTime:
        return _CupertinoDatePickerDateTimeState();
      case CupertinoMonthYearMode.date:
...
class _CupertinoDatePickerDateTimeState extends State<CupertinoMonthYearPicker> {
  ...
  @override
  void didUpdateWidget(CupertinoMonthYearPicker oldWidget) {
  ...
  double _getEstimatedColumnWidth(_PickerColumnType columnType) {
    if (estimatedColumnWidths[columnType.index] == null) {
      estimatedColumnWidths[columnType.index] =
          CupertinoMonthYearPicker._getColumnWidth(columnType, localizations, context);
    }
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.mode == CupertinoMonthYearMode.dateAndTime) {
...
class _CupertinoDatePickerDateState extends State<CupertinoMonthYearPicker> {
  ...
  void _refreshEstimatedColumnWidths() {
    estimatedColumnWidths[_PickerColumnType.dayOfMonth.index] = CupertinoMonthYearPicker._getColumnWidth(_PickerColumnType.dayOfMonth, localizations, context);
    estimatedColumnWidths[_PickerColumnType.month.index] = CupertinoMonthYearPicker._getColumnWidth(_PickerColumnType.month, localizations, context);
    estimatedColumnWidths[_PickerColumnType.year.index] = CupertinoMonthYearPicker._getColumnWidth(_PickerColumnType.year, localizations, context);
  }
