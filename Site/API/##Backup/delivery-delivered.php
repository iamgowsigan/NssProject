...
if (strlen($_SESSION['login']) == 0) {
	...
	$_SESSION['lastpage'] = 'delivery-delivered.php';
	//ADD 

	if (isset($_POST['viewbutton'])) {
		$orderid = addslashes($_POST['orderid']);
		$_SESSION['orderid'] = $orderid;
		$_SESSION['orderaction'] = 'S';
						...
						<div class="row"><!-- container Start-->
							...
							<div class="col-lg-12">
								<div class="card">
									...
									<div class="card-body">
										<h4><?php mylan("Delivered Order List ", "قائمة الطلبات التي تم تسليمها "); ?></h4>
