...
if (strlen($_SESSION['login']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$field['valid'] = date("Ymd", strtotime(" +12 months"));
		$field['subscribe'] = '1';
	...
	if (isset($_POST['update'])) {
		...
		if ($checkPhone == 0) {
			...
			if ($checkemail == 0) {
				...
				$field['city'] = addslashes($_POST['city']);
				$field['valid'] = addslashes($_POST['valid']);
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-12">
								<div class="page-title-box">
									...
									<h4 class="page-title">Manage Shop</h4>
								</div>
							</div>
						</div>
						<div class="row"><!-- container Start-->
							...
							<?php if ($edit == 0) { ?>
								...
								<button type="button" class="btn btn-primary m-2" data-toggle="modal" data-target="#signup-modal">Add Shop</button>
										...
										<div class="card-body">
											<table data-order='[[ 0, "desc" ]]' id="basic-datatable" class="table dt-responsive nowrap w-100">
												...
												<tbody>
													...
													$listdata = Selectdata("Select * FROM user WHERE shop_name!=''");
													...
													?>
														...
														<tr>
															...
															<td><?php text($row['shop_name'], $strong = true, $small = false, $badge = false, $lighten = false, $outline = false, ''); ?><br>
															...
															<td>
																<?php
																$getuid = $row['u_id'];
																$countProduct = Countdata("SELECT * FROM products WHERE u_id='$getuid'");
																text($countProduct . ' ' . 'Items', $strong = false, $small = true, $badge = true, $lighten = true, $outline = false, 'info'); ?>
															</td>
															...
															<td><?php active($row['shop_live'], $row['u_id']); ?></td>

															<td><?php action($row['u_id'], 'V,E,D', $name = $row['shop_name']); ?></td>
												...
												<div class="card">
													<div class="card-body">
														...
														<div class="row">
															...
															<?php formimage('Shop Picture',  'image',  $row['profile_pic'],  '',  '6',  'oldimage',  '70',  '70',  'cover'); ?>
												...
												<div class="card">
													<div class="card-body">
														...
														<div class="row">
															...
															<?php forminput('Shop Name',  'shop_name',  $row['shop_name'],  'required',  '6',  'text'); ?>
															...
															$expLable='';
															if($daysdiff>0){
																$expLable=$daysdiff.' Days Left';
															}else{
																$expLable='Expired';
															}

															forminput('Subscription (YYYYMMDD) '.'&nbsp;&nbsp;'.$expLable,  'valid',  $row['valid'],  'required',  '6',  'text','YYYYMMDD'); ?>
