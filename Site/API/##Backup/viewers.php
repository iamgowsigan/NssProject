<?php
	...
	{ 
		...
		if ($_GET['action'] == 'del' && $_GET['scid']) {
			$id = intval($_GET['scid']);
			$res=Deletedata("delete from viewer where v_id='$id'");
							...
							<div class="row">
								<div class="col-12">
									<div class="page-title-box">
										...
										<h4 class="page-title"><?=$pname;?>&nbsp;Views</h4>
									</div>
								</div>
							</div>   
												...
												<table data-order='[[ 0, "desc" ]]' id="basic-datatable" class="table dt-responsive nowrap w-100">
													...
													<tbody>
														<?php
															...
															$listdata=Selectdata("Select viewer.*,user.* FROM viewer JOIN user ON user.u_id=viewer.u_id WHERE viewer.screen='PRODUCT' AND viewer.f_id='$pid'");
																...
																<tr>
																	<?php
																		...
																		<tr>
																			...
																			<td><?php text( $row['v_dated'], $strong=false, $small=true, $badge=false, $lighten=false, $outline=false, '' ); ?></td>
																			
																			<td><?php action(  $row['v_id'] ,'D',$name=$row['name']   ); ?></td>
